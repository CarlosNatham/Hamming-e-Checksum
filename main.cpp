...
int main()
{
    ...
    cout << "Escolha qual opção deseja realizar:" << endl; // menu de escolha da operação
    ...
    cout << "Sua opção: "; //6+4+4+4+9+1+1 = 29 bits - impar
    cin >> resp;
    ...
    case 0: //hamming 12,8
        ...
        else   // se caso foi escolhido a injeção de erro, ele vai para esta parte
        {
            ...
            cout << " - Posição: " << (erro0[3] * 8) + (erro0[2] * 4) + (erro0[1] * 2) + erro0[0] << endl; // converte o valor para decimal
    ...
    case 1: //hamming 15,11
        ...
        else   // se caso foi escolhido a injeção de erro, ele vai para esta parte
        {
            ...
            cout << " - Posição: " << (erro1[3] * 8) + (erro1[2] * 4) + (erro1[1] * 2) + erro1[0] << endl; // converte o valor para decimal
    ...
    case 2:
        ...
        cout << endl;
        cout << "Soma 1 depois do overflow: ";
        for(i = 0; i<11; i ++)
        {
            cout << soma1[i];
        }
        ...
        cout << endl;
        cout << "Soma 2 depois do overflow: ";
        for(i = 0; i<11; i ++)
        {
            cout << soma2[i];
        }
